...
REM     echo "%%~nf" | findstr /R /C:"production" > NUL
REM     IF !ERRORLEVEL! EQU 0 (
REM         start "Distributing APK" cmd /c firebase appdistribution:distribute "%%~dpnxf" --app %FIREBASE_PROJECT_ID% --groups production-testers
REM     )
)
